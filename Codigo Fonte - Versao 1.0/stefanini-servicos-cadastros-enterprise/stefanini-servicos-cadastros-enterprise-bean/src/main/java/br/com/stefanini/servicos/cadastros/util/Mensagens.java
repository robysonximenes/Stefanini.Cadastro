 ...
 * @author Ximenes
 * Date 10/03/2020
 * Class Representa Constantes staticas utilizadas nos Status dos servicos
 */
public class Mensagens {
    
    public static final String PESSOA_JA_CADASTRADO = "Pessoa já Cadastrada, Verificar CPF";
    ...
    public static final String FUNCIONARIO_NAO_TEM_PERMISSSAO = "Funcionario não tem permissão, ou Senha foi digitada errada";
    public static final String COD_FUNCIONARIO_NAO_TEM_PERMISSSAO = "CFNTP003";
    public static final String PESSOA_NAO_LOCALIZADO = "Pessoa Não Localizada";
    public static final String COD_PESSOA_NAO_LOCALIZADO = "CCNL004";
    public static final String PESSOA_CPF_NAO_LOCALIZADO = "Pessoa Não Cadastrada";
    ...
    public static final String COD_EMAIL_INVALIDO = "CEI043";
    public static final String DATA_INVALIDA = "Data Invalida, Campo Obrigatorio no formado dd/mm/yyyy";
    public static final String COD_DATA_INVALIDA = "CDI044";
    public static final String CADASTRO_EXCLUIDO_SUCESSO = "Cadadstro Excluido com Sucesso";
    public static final String COD_CADASTRO_EXCLUIDO_SUCESSO = "CCES045";
    public static final String AUTENTICADO_COM_SUCESSO = "Autenticado com Sucesso";
    //Tipo Mensagem
    ...
    public static final String COD_ERRO_GENERICO = "9999";
}
